...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 15.2.1 20260103'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_ccasflags=''
grub_ldflags='-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs -flto=auto'
